...
var slideBtn = slideBtnArea.children('button');
...
// animation기능 수행을 위해 마지막요소를 복제(clone()) 앞에다 붙이기
// 1. css에서는 js에서 순서를바꿔도 그냥 바뀐대로의 순서로 배치
...
slideBtn.on('click', function(e){
 ...
 productUl.animate({marginLeft:mvFn()}, function(){
   permission = true;
 });
 nowCFn();
 }
